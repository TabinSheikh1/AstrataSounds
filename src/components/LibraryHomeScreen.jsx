...
const INSTRUMENT_OPTIONS = [
  ...
  { label: "Classical Guitar", value: 'classical_guitar' },
  { label: "12-String Guitar", value: '12_string_guitar' },
  { label: "Bass Guitar", value: 'bass_guitar' },
  { label: "Double Bass", value: 'double_bass' },
  { label: "Upright Bass", value: 'upright_bass' },
  ...
  { label: "Oud", value: 'oud' },
  { label: "Bouzouki", value: 'bouzouki' },
  { label: "Balalaika", value: 'balalaika' },
  { label: "Charango", value: 'charango' },
  { label: "Dulcimer", value: 'dulcimer' },
  ...
  { label: "Autoharp", value: 'autoharp' },
  { label: "Resonator Guitar", value: 'resonator_guitar' },
  { label: "Slide Guitar", value: 'slide_guitar' },
  { label: "Pedal Steel Guitar", value: 'pedal_steel_guitar' },
  { label: "Lap Steel Guitar", value: 'lap_steel_guitar' },
  { label: "Fiddle", value: 'fiddle' },
  { label: "Rebab", value: 'rebab' },
  { label: "Kora", value: 'kora' },
  { label: "Bass Ukulele", value: 'bass_ukulele' },
  { label: "12-String Banjo", value: '12_string_banjo' },
  ...
  { label: "Bamboo Flute", value: 'bamboo_flute' },
  { label: "Duduk", value: 'duduk' },
  { label: "Shakuhachi", value: 'shakuhachi' },
  { label: "Bagpipes", value: 'bagpipes' },
  { label: "Harmonica", value: 'harmonica' },
  { label: "Melodica", value: 'melodica' },
  { label: "Ocarina", value: 'ocarina' },
  { label: "Bansuri", value: 'bansuri' },
  { label: "Dizi", value: 'dizi' },
  ...
  { label: "Bass Trombone", value: 'bass_trombone' },
  ...
  { label: "Alphorn", value: 'alphorn' },
  { label: "Piano", value: 'piano' },
  { label: "Grand Piano", value: 'grand_piano' },
  { label: "Upright Piano", value: 'upright_piano' },
  { label: "Electric Piano", value: 'electric_piano' },
  { label: "Rhodes Piano", value: 'rhodes_piano' },
  { label: "Wurlitzer", value: 'wurlitzer' },
  { label: "Organ", value: 'organ' },
  { label: "Hammond Organ", value: 'hammond_organ' },
  { label: "Pipe Organ", value: 'pipe_organ' },
  { label: "Harpsichord", value: 'harpsichord' },
  { label: "Clavichord", value: 'clavichord' },
  { label: "Synthesizer", value: 'synthesizer' },
  { label: "Analog Synth", value: 'analog_synth' },
  { label: "Digital Synth", value: 'digital_synth' },
  { label: "Mellotron", value: 'mellotron' },
  { label: "Celesta", value: 'celesta' },
  { label: "Accordion", value: 'accordion' },
  { label: "Keytar", value: 'keytar' },
  { label: "Clavinet", value: 'clavinet' },
  { label: "Toy Piano", value: 'toy_piano' },
  { label: "Drum Kit", value: 'drum_kit' },
  { label: "Snare Drum", value: 'snare_drum' },
  { label: "Bass Drum", value: 'bass_drum' },
  { label: "Hi-Hat", value: 'hi_hat' },
  { label: "Cymbals", value: 'cymbals' },
  { label: "Tom-Toms", value: 'tom_toms' },
  ...
  { label: "Steel Drum", value: 'steel_drum' },
  { label: "Tabla", value: 'tabla' },
  { label: "Talking Drum", value: 'talking_drum' },
  { label: "Taiko Drum", value: 'taiko_drum' },
  { label: "Bodhran", value: 'bodhran' },
  { label: "Frame Drum", value: 'frame_drum' },
  { label: "Triangle", value: 'triangle' },
  { label: "Tambourine", value: 'tambourine' },
  { label: "Maracas", value: 'maracas' },
  { label: "Shakers", value: 'shakers' },
  { label: "Claves", value: 'claves' },
  ...
  { label: "Bell Tree", value: 'bell_tree' },
  { label: "Crotales", value: 'crotales' },
  ...
  { label: "Sequencer", value: 'sequencer' },
  { label: "Modular Synth", value: 'modular_synth' },
  { label: "808 Drum Machine", value: '808_drum_machine' },
  { label: "Beatbox", value: 'beatbox' },
  { label: "Loop Pedal", value: 'loop_pedal' },
  { label: "Talk Box", value: 'talk_box' },
  { label: "Wavetable Synth", value: 'wavetable_synth' },
  { label: "FM Synth", value: 'fm_synth' },
  { label: "Granular Synth", value: 'granular_synth' },
  { label: "Choir", value: 'choir' },
  { label: "Vocal Ensemble", value: 'vocal_ensemble' },
  { label: "A Cappella Ensemble", value: 'a_cappella_ensemble' },
  { label: "Barbershop Quartet", value: 'barbershop_quartet' },
  { label: "Beatboxer", value: 'beatboxer' },
  { label: "Didgeridoo", value: 'didgeridoo' },
  { label: "Santoor", value: 'santoor' },
  { label: "Sarangi", value: 'sarangi' },
  { label: "Ney", value: 'ney' },
  { label: "Hurdy-Gurdy", value: 'hurdy_gurdy' },
  { label: "Panpipes", value: 'panpipes' },
  { label: "Jaw Harp", value: 'jaw_harp' },
  { label: "Nose Flute", value: 'nose_flute' },
  { label: "Conch Shell", value: 'conch_shell' },
  { label: "Vuvuzela", value: 'vuvuzela' },
  { label: "Shofar", value: 'shofar' },
  { label: "Bullroarer", value: 'bullroarer' },
  { label: "Cimbalom", value: 'cimbalom' },
  { label: "Hang Drum", value: 'hang_drum' },
  { label: "Erhu Bass", value: 'erhu_bass' },
  { label: "Pipa", value: 'pipa' },
  { label: "Guqin", value: 'guqin' },
  { label: "Yangqin", value: 'yangqin' },
  { label: "Morin Khuur", value: 'morin_khuur' },
  { label: "Duduk Bass", value: 'duduk_bass' },
  { label: "Concertina", value: 'concertina' },
  { label: "Bandoneon", value: 'bandoneon' },
  { label: "Log Drum", value: 'log_drum' },
  { label: "Slit Drum", value: 'slit_drum' },
  { label: "Rainstick", value: 'rainstick' },
  { label: "Ocean Drum", value: 'ocean_drum' },
  { label: "Berimbau", value: 'berimbau' },
  { label: "Waterphone", value: 'waterphone' },
  { label: "Singing Bowl", value: 'singing_bowl' },
  { label: "Tibetan Bowl", value: 'tibetan_bowl' },
  { label: "Zurna", value: 'zurna' },
  { label: "Tin Whistle", value: 'tin_whistle' },
  { label: "Irish Flute", value: 'irish_flute' },
  { label: "Uilleann Pipes", value: 'uilleann_pipes' },
  { label: "Bombard", value: 'bombard' },
  { label: "Crumhorn", value: 'crumhorn' },
  { label: "Shawm", value: 'shawm' },
  { label: "Sackbut", value: 'sackbut' },
  { label: "Serpent", value: 'serpent' },
  { label: "Ophicleide", value: 'ophicleide' },
  { label: "Wagner Tuba", value: 'wagner_tuba' },
  { label: "Cimbasso", value: 'cimbasso' },
  { label: "Contrabass Clarinet", value: 'contrabass_clarinet' },
];

const GENRE_OPTIONS = [
  { label: "Pop", value: 'pop' },
  { label: "Dance Pop", value: 'dance_pop' },
  { label: "Electropop", value: 'electropop' },
  { label: "Synth-pop", value: 'synth_pop' },
  { label: "Dream Pop", value: 'dream_pop' },
  { label: "Indie Pop", value: 'indie_pop' },
  { label: "Bedroom Pop", value: 'bedroom_pop' },
  { label: "Bubblegum Pop", value: 'bubblegum_pop' },
  { label: "Teen Pop", value: 'teen_pop' },
  { label: "Art Pop", value: 'art_pop' },
  { label: "Chamber Pop", value: 'chamber_pop' },
  { label: "Baroque Pop", value: 'baroque_pop' },
  { label: "Power Pop", value: 'power_pop' },
  { label: "City Pop", value: 'city_pop' },
  { label: "K-Pop", value: 'k_pop' },
  { label: "J-Pop", value: 'j_pop' },
  { label: "C-Pop", value: 'c_pop' },
  ...
  { label: "UK Drill", value: 'uk_drill' },
  { label: "Boom Bap", value: 'boom_bap' },
  { label: "Conscious Hip-Hop", value: 'conscious_hip_hop' },
  { label: "Gangsta Rap", value: 'gangsta_rap' },
  { label: "Cloud Rap", value: 'cloud_rap' },
  { label: "Emo Rap", value: 'emo_rap' },
  { label: "Mumble Rap", value: 'mumble_rap' },
  { label: "Old School Hip-Hop", value: 'old_school_hip_hop' },
  { label: "Chopped and Screwed", value: 'chopped_and_screwed' },
  { label: "Crunk", value: 'crunk' },
  { label: "Grime", value: 'grime' },
  { label: "Phonk", value: 'phonk' },
  { label: "Horrorcore", value: 'horrorcore' },
  { label: "Latin Trap", value: 'latin_trap' },
  { label: "Afro Trap", value: 'afro_trap' },
  { label: "Trap Soul", value: 'trap_soul' },
  { label: "R&B", value: 'randb' },
  { label: "Contemporary R&B", value: 'contemporary_randb' },
  { label: "Neo Soul", value: 'neo_soul' },
  { label: "Soul", value: 'soul' },
  { label: "Motown", value: 'motown' },
  { label: "Funk", value: 'funk' },
  { label: "Quiet Storm", value: 'quiet_storm' },
  { label: "New Jack Swing", value: 'new_jack_swing' },
  { label: "Doo-Wop", value: 'doo_wop' },
  { label: "Southern Soul", value: 'southern_soul' },
  { label: "Blue-Eyed Soul", value: 'blue_eyed_soul' },
  { label: "Gospel", value: 'gospel' },
  { label: "Southern Gospel", value: 'southern_gospel' },
  { label: "Praise and Worship", value: 'praise_and_worship' },
  { label: "Contemporary Christian", value: 'contemporary_christian' },
  { label: "Christian Rock", value: 'christian_rock' },
  { label: "Christian Pop", value: 'christian_pop' },
  { label: "Spiritual", value: 'spiritual' },
  { label: "Negro Spiritual", value: 'negro_spiritual' },
  { label: "Gospel Blues", value: 'gospel_blues' },
  { label: "Rock", value: 'rock' },
  { label: "Classic Rock", value: 'classic_rock' },
  { label: "Hard Rock", value: 'hard_rock' },
  { label: "Soft Rock", value: 'soft_rock' },
  { label: "Alternative Rock", value: 'alternative_rock' },
  { label: "Indie Rock", value: 'indie_rock' },
  { label: "Garage Rock", value: 'garage_rock' },
  { label: "Psychedelic Rock", value: 'psychedelic_rock' },
  { label: "Progressive Rock", value: 'progressive_rock' },
  { label: "Art Rock", value: 'art_rock' },
  { label: "Post-Rock", value: 'post_rock' },
  { label: "Math Rock", value: 'math_rock' },
  { label: "Southern Rock", value: 'southern_rock' },
  { label: "Blues Rock", value: 'blues_rock' },
  { label: "Folk Rock", value: 'folk_rock' },
  { label: "Surf Rock", value: 'surf_rock' },
  { label: "Glam Rock", value: 'glam_rock' },
  { label: "Grunge", value: 'grunge' },
  { label: "Post-Punk", value: 'post_punk' },
  { label: "Punk Rock", value: 'punk_rock' },
  { label: "Pop Punk", value: 'pop_punk' },
  { label: "Hardcore Punk", value: 'hardcore_punk' },
  { label: "Emo", value: 'emo' },
  { label: "Screamo", value: 'screamo' },
  { label: "Post-Hardcore", value: 'post_hardcore' },
  { label: "Krautrock", value: 'krautrock' },
  { label: "Yacht Rock", value: 'yacht_rock' },
  { label: "Stoner Rock", value: 'stoner_rock' },
  { label: "Space Rock", value: 'space_rock' },
  { label: "Rockabilly", value: 'rockabilly' },
  { label: "Heavy Metal", value: 'heavy_metal' },
  { label: "Thrash Metal", value: 'thrash_metal' },
  { label: "Death Metal", value: 'death_metal' },
  { label: "Black Metal", value: 'black_metal' },
  { label: "Doom Metal", value: 'doom_metal' },
  { label: "Sludge Metal", value: 'sludge_metal' },
  { label: "Power Metal", value: 'power_metal' },
  { label: "Symphonic Metal", value: 'symphonic_metal' },
  { label: "Nu Metal", value: 'nu_metal' },
  { label: "Metalcore", value: 'metalcore' },
  { label: "Deathcore", value: 'deathcore' },
  { label: "Progressive Metal", value: 'progressive_metal' },
  { label: "Folk Metal", value: 'folk_metal' },
  { label: "Industrial Metal", value: 'industrial_metal' },
  { label: "Groove Metal", value: 'groove_metal' },
  { label: "Gothic Metal", value: 'gothic_metal' },
  { label: "Viking Metal", value: 'viking_metal' },
  { label: "Speed Metal", value: 'speed_metal' },
  ...
  { label: "Electro House", value: 'electro_house' },
  { label: "Future House", value: 'future_house' },
  { label: "Tropical House", value: 'tropical_house' },
  { label: "Techno", value: 'techno' },
  { label: "Minimal Techno", value: 'minimal_techno' },
  { label: "Trance", value: 'trance' },
  { label: "Progressive Trance", value: 'progressive_trance' },
  { label: "Psytrance", value: 'psytrance' },
  { label: "Dubstep", value: 'dubstep' },
  { label: "Brostep", value: 'brostep' },
  { label: "Drum and Bass", value: 'drum_and_bass' },
  { label: "Jungle", value: 'jungle' },
  { label: "Breakbeat", value: 'breakbeat' },
  { label: "Big Beat", value: 'big_beat' },
  ...
  { label: "Dark Ambient", value: 'dark_ambient' },
  { label: "IDM", value: 'idm' },
  { label: "Glitch", value: 'glitch' },
  { label: "Future Bass", value: 'future_bass' },
  { label: "Hardstyle", value: 'hardstyle' },
  { label: "Gabber", value: 'gabber' },
  { label: "Bass Music", value: 'bass_music' },
  { label: "Dub", value: 'dub' },
  { label: "Dubtechno", value: 'dubtechno' },
  { label: "Electroclash", value: 'electroclash' },
  { label: "UK Garage", value: 'uk_garage' },
  { label: "Speed Garage", value: 'speed_garage' },
  { label: "Trip-Hop", value: 'trip_hop' },
  { label: "Witch House", value: 'witch_house' },
  { label: "Hyperpop", value: 'hyperpop' },
  { label: "Lo-Fi Hip-Hop", value: 'lo_fi_hip_hop' },
  { label: "Chillout", value: 'chillout' },
  { label: "Chillhop", value: 'chillhop' },
  { label: "Study Beats", value: 'study_beats' },
  { label: "Bedroom Chill", value: 'bedroom_chill' },
  { label: "Sleep Ambient", value: 'sleep_ambient' },
  { label: "Jazz", value: 'jazz' },
  { label: "Smooth Jazz", value: 'smooth_jazz' },
  { label: "Bebop", value: 'bebop' },
  { label: "Swing", value: 'swing' },
  { label: "Big Band", value: 'big_band' },
  { label: "Cool Jazz", value: 'cool_jazz' },
  { label: "Free Jazz", value: 'free_jazz' },
  { label: "Fusion Jazz", value: 'fusion_jazz' },
  { label: "Latin Jazz", value: 'latin_jazz' },
  { label: "Acid Jazz", value: 'acid_jazz' },
  { label: "Nu Jazz", value: 'nu_jazz' },
  { label: "Gypsy Jazz", value: 'gypsy_jazz' },
  { label: "Dixieland", value: 'dixieland' },
  { label: "Modal Jazz", value: 'modal_jazz' },
  { label: "Hard Bop", value: 'hard_bop' },
  { label: "Blues", value: 'blues' },
  { label: "Delta Blues", value: 'delta_blues' },
  { label: "Chicago Blues", value: 'chicago_blues' },
  { label: "Electric Blues", value: 'electric_blues' },
  { label: "Country Blues", value: 'country_blues' },
  { label: "Piedmont Blues", value: 'piedmont_blues' },
  { label: "Classical", value: 'classical' },
  { label: "Baroque", value: 'baroque' },
  { label: "Romantic Era", value: 'romantic_era' },
  { label: "Contemporary Classical", value: 'contemporary_classical' },
  { label: "Minimalism", value: 'minimalism' },
  { label: "Opera", value: 'opera' },
  { label: "Chamber Music", value: 'chamber_music' },
  { label: "Orchestral", value: 'orchestral' },
  { label: "Choral", value: 'choral' },
  { label: "Avant-Garde Classical", value: 'avant_garde_classical' },
  { label: "Country", value: 'country' },
  { label: "Country Pop", value: 'country_pop' },
  { label: "Outlaw Country", value: 'outlaw_country' },
  { label: "Bluegrass", value: 'bluegrass' },
  { label: "Americana", value: 'americana' },
  { label: "Folk", value: 'folk' },
  { label: "Contemporary Folk", value: 'contemporary_folk' },
  { label: "Singer-Songwriter", value: 'singer_songwriter' },
  { label: "Appalachian Folk", value: 'appalachian_folk' },
  { label: "Celtic Folk", value: 'celtic_folk' },
  { label: "Sea Shanty", value: 'sea_shanty' },
  { label: "Honky Tonk", value: 'honky_tonk' },
  { label: "Alt-Country", value: 'alt_country' },
];
  ...
  return (
    <View style={styles.vibeCard}>
      ...
      >
        ...
        {/* Genres */}
        {vibe.genres?.length > 0 && (
          <View style={styles.vibeChipRow}>
            {vibe.genres.map((g) => {
              const opt = GENRE_OPTIONS.find((o) => o.value === g);
              return (
                <View key={g} style={styles.moodChip}>
                  <Text style={styles.moodChipText}>{opt?.label ?? g}</Text>
                </View>
              );
            })}
          </View>
...
const CreateVibeModal = ({ visible, onClose, onCreate }) => {
  ...
  const resetForm = () => {
    ...
    setMoods([]); setGenres([]); setInstruments([]); setSettings([]); setKeywords([]);
  };
  ...
  const handleCreate = async () => {
    ...
    if (genres.length === 0) { Alert.alert('Missing field', 'Select at least one genre.'); return; }
        ...
        <Animated.View style={[styles.modalContainer, { transform: [{ translateY: slideAnim }] }]}>
          ...
          >
            ...
            >
              ...
              {/* Genres */}
              <Text style={styles.fieldLabel}>Genres <Text style={styles.fieldLabelSub}>(select multiple)</Text></Text>
              <ChipSelect
                options={GENRE_OPTIONS}
                selected={genres}
                onToggle={(v) => toggleMulti(setGenres, v)}
                multi
              />
